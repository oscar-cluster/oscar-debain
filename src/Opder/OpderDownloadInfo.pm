...
use lib "../Installer"; use InstallerImages; use InstallerUtils;;
...
sub NEW
{
    ...
    my $OpderDownloadInfoLayout = Qt::GridLayout(this, 1, 1, 1, 6, '$OpderDownloadInfoLayout');

    my $layout19 = Qt::VBoxLayout(undef, 11, 6, '$layout19');
    ...
    $layout19->addWidget(downloadLabel);
    ...
    $layout19->addWidget(cancelButton);

    $OpderDownloadInfoLayout->addLayout($layout19, 0, 0);
